  ...
  void released() {
   ...
   //-----------------------------------------------------------bounce00 
    ...
    //-----------------------------------------------------------bounce01   
     ...
     //-----------------------------------------------------------bounce03
       if(bounce03 == true){
         upCurve02 = mouseY + (890-mouseY)/3; // mouseY + (890-mouseY)/3*2
         upCurve02 = upCurve02 * 2;
         distance03 = underCurve02 - upCurve02;
         stillPointY -= distance03 * easing;
         print(upCurve02);
       if (stillPointY <= upCurve02 && bounce03 == true && pressed == false) {
         bounce03 = false;
         bounce04 = true;
       }
       }
    //-----------------------------------------------------------bounce03
      if(bounce04 == true){
        underCurve03 = 890 + (890 - mouseY)/6;
        distance04 = underCurve03 - upCurve02;
        stillPointY += distance04 * easing;
      }
      if (stillPointY >= underCurve03 && bounce04 == true && pressed == false) {
        bounce04 = false;
        bounce05 = true;
      }
    //-----------------------------------------------------------bounce04
      if(bounce05 == true){
        upCurve03 = upCurve02 +(890 - upCurve02)/2;
        distance05 = underCurve03 - upCurve03;
        stillPointY -= distance05 * easing;
      }
      if (stillPointY <= upCurve03 && bounce05 == true && pressed == false) {
        bounce05 = false;
        bounce06 = true;
      }
    //-----------------------------------------------------------bounce05
     if(bounce06 == true){
        underCurve04 = 890 + (890 - mouseY)/8;
        distance06 = underCurve04 - upCurve03;
        stillPointY += distance05 * easing;
      }
      if (stillPointY >= upCurve03 && bounce06 == true && pressed == false) {
        bounce06 = false;
        bounce07 = true;
      }
    //-----------------------------------------------------------bounce06
    if(bounce07 == true){
        upCurve04 = upCurve02 +(890 - upCurve02)/1.1;
        distance07 = underCurve04 - upCurve04;
        stillPointY -= distance07 * easing;
      }
      if (stillPointY <= upCurve04 && bounce07 == true && pressed == false) {
        bounce07 = false;
        stillPointY = upCurve04;
      }
